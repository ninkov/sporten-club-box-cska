const projects = [
  {
    title: 'Детско-юношеска школа',
    meta: 'Развитие',
    text: 'Подготовка на млади състезатели с фокус върху дисциплина, техника и постепенно участие в турнири.',
  },
  {
    title: 'Състезателна подготовка',
    meta: 'Спорт',
    text: 'Работа с активни боксьори за национални първенства, контролни срещи и клубни състезания.',
  },
  {
  ...
  return (
    <section className="projects-section" id="projects" aria-labelledby="projects-title">
      <div className="section-heading">
        ...
        <p>
          Тук могат да се представят текущи и бъдещи проекти на клуба - школа,
